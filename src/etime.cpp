/*
* Copyright (c) 2009-2018 Brian Waters
*
...
ETime::ETime(Int year, Int mon, Int day, Int hour, Int min, Int sec, Bool isLocal)
{
   timeval tv;
   struct tm t;
...
bool ETime::ParseDateTime(cpStr pszDate, bool isLocal)
{
