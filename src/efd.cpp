...
static Void copy( struct avp *from, msg_or_avp *to )
{
   ...
   if ( ret != 0 )
      throw FDException(
         EUtility::string_format("%s:%d - ERROR - Error [%d] retrieving avp dict_object",
   ...
   if ( ret != 0 )
      throw FDException(
         EUtility::string_format("%s:%d - ERROR - Error [%d] retrieving avp dictionary data",
         __FILE__, __LINE__, ret )
      );
   ...
   if ( ret != 0 )
      throw FDException(
         EUtility::string_format("%s:%d - ERROR - Error [%d] createing new AVP [%s]",
   ...
   else
   {
      ...
      if ( ret != 0 )
         throw FDException(
            EUtility::string_format("%s:%d - ERROR - fd_msg_avp_hdr returned %d retrieving header for [%s]",
            __FILE__, __LINE__, ret, avp_data.avp_name )
         );
      ...
      if ( ret != 0 )
         throw FDException(
            EUtility::string_format("%s:%d - ERROR - fd_msg_avp_setvalue returned %d setting the AVP value for [%s]",
            __FILE__, __LINE__, ret, avp_data.avp_name )
         );
   }
   ...
   if ( ret != 0 )
      throw FDException(
         EUtility::string_format("%s:%d - ERROR - Error [%d] adding [%s] AVP",
         __FILE__, __LINE__, ret, avp_data.avp_name )
      );
}
...
static Void copyall( msg_or_avp *from, msg_or_avp *to )
{
   ...
   if ( ret != 0 )
      throw FDException(
         EUtility::string_format("%s:%d - ERROR - browse returned %d direction MSG_BRW_FIRST_CHILD",
         __FILE__, __LINE__, ret )
      );
   ...
   while ( loopavp )
   {
      ...
      if ( ret != 0 )
         throw FDException(
            EUtility::string_format("%s:%d - ERROR - browse returned %d direction MSG_BRW_NEXT",
            __FILE__, __LINE__, ret )
         );
   }
}
...
Void FDEngine::advertiseSupport( FDDictionaryEntryApplication &app, int auth, int acct )
{
   ...
   if ( ret != 0 )
      throw FDException(
         EUtility::string_format("%s:%d - ERROR - Unable to register support for [%s] ret=%d",
...
Void FDEngine::advertiseSupport( FDDictionaryEntryApplication &app, FDDictionaryEntryVendor &vendor, int auth, int acct )
{
   ...
   if ( ret != 0 )
      throw FDException(
         EUtility::string_format("%s:%d - ERROR - Unable to register support for [%s] vendor [%s] ret=%d",
   ...
   : FDDictionaryEntry( name, DICT_APPLICATION, APPLICATION_BY_NAME, dict )
{
   if ( !isValid() )
      throw FDException(
         EUtility::string_format( "%s:%d - Unable to find application dictionary entry for [%s]",
...
bool FDDictionaryEntryApplication::init()
{
   ...
   if ( ret != 0 )
      throw FDException(
         EUtility::string_format( "%s:%d - Unable to find get data associated with application",
         __FILE__, __LINE__ )
      );
   ...
   : FDDictionaryEntry( name, DICT_VENDOR, VENDOR_BY_NAME, dict )
{
   if ( !isValid() )
      throw FDException(
         EUtility::string_format( "%s:%d - Unable to find vendor dictionary entry for [%s]",
         __FILE__, __LINE__, name )
      );
   ...
   : FDDictionaryEntry( &vendorid, DICT_VENDOR, VENDOR_BY_ID, dict )
{
   if ( !isValid() )
      throw FDException(
         EUtility::string_format( "%s:%d - Unable to find vendor dictionary entry for vendor id [%u]",
   ...
   : FDDictionaryEntry( app.getEntry(), DICT_VENDOR, VENDOR_OF_APPLICATION, dict )
{
   if ( !isValid() )
      throw FDException(
         EUtility::string_format( "%s:%d - Unable to find vendor dictionary entry for application [%s]",
...
bool FDDictionaryEntryVendor::init()
{
   ...
   if ( ret != 0 )
      throw FDException(
         EUtility::string_format( "%s:%d - Unable to find get data associated with vendor",
         __FILE__, __LINE__ )
      );
     ...
     m_datatype( DDTUnknown )
{
   ...
   if ( isValid() )
      ...
      throw FDException(
         EUtility::string_format( "%s:%d - INFO - Unable to find AVP dictionary entry for [%s]",
         __FILE__, __LINE__, name )
      );
}
     ...
     m_datatype( DDTUnknown )
{
   ...
   if ( isValid() )
      ...
      throw FDException(
         EUtility::string_format( "%s:%d - INFO - Unable to find AVP dictionary entry for [%s] vendor [%u]",
     ...
     m_datatype( DDTUnknown )
{
   ...
   if ( isValid() )
      ...
      throw FDException(
         EUtility::string_format( "%s:%d - INFO - dict_object* is NULL",
         __FILE__, __LINE__ )
      );
}
   ...
   : FDDictionaryEntry( name, DICT_COMMAND, CMD_BY_NAME, dict )
{
   if ( !isValid() )
      throw FDException(
         EUtility::string_format( "%s:%d - INFO - Unable to find command dictionary entry for [%s]",
         __FILE__, __LINE__, name )
      );
   ...
   if ( ret != 0 )
      throw FDException(
         EUtility::string_format( "%s:%d - INFO - Unable to retrieve command data for [%s]",
         __FILE__, __LINE__, name )
      );
}
   ...
   : FDDictionaryEntry( (const Void *)&cmdid, DICT_COMMAND, CMD_BY_CODE_R, dict )
{
   if ( !isValid() )
      throw FDException(
         EUtility::string_format( "%s:%d - INFO - Unable to find command dictionary entry for command code [%u]",
   ...
   : FDDictionaryEntry( req.getEntry(), DICT_COMMAND, CMD_ANSWER, dict != NULL ? dict : (struct dictionary *)req.getDictionary() )
{
   if ( !isValid() )
      throw FDException(
         EUtility::string_format( "%s:%d - INFO - Unable to find answer command dictionary entry for request command [%s]",
   ...
   if ( ret != 0 )
      throw FDException(
         EUtility::string_format( "%s:%d - INFO - Unable to find answer command dictionary entry for answer command [%s]",
         __FILE__, __LINE__, req.m_data.cmd_name )
      );
}
     ...
     m_dedel( dedel )
{
   ...
   if ( m_avp )
   {
      ...
      if ( ret != 0 )
      throw FDException(
         EUtility::string_format("%s:%d - ERROR - error retrieving AVP header",
         __FILE__, __LINE__ )
      );
   }
}
...
bool FDAvp::get( ETime &v )
{
   ...
   {
      throw FDException(
         EUtility::string_format( "%s:%d - INFO - Unable to assign [%s] to ETime value",
...
FDAvp &FDAvp::set( const ETime &v )
{
   ...
   {
      throw FDException(
         EUtility::string_format( "%s:%d - INFO - Unable to assign ETime value to [%s]",
         __FILE__, __LINE__, m_de->getName() )
      );
   }
...
FDAvp FDAvp::getNext( bool &found )
{
   ...
   if ( found )
   {
      ...
      if ( ret != 0 )
         throw FDException(
            EUtility::string_format("%s:%d - INFO - unalbe to retrieve avp model",
            __FILE__, __LINE__, ret )
         );
...
Void FDAvp::init()
{
   ...
   if ( !m_avp && ( ret = fd_msg_avp_new( m_de->getEntry(), 0, &m_avp ) ) != 0)
      throw FDException(
         EUtility::string_format("%s:%d - ERROR - Error [%d] creating [%s] AVP",
         __FILE__, __LINE__, ret, m_de->getName() )
      );
   ...
   try
   {
      if ( m_de->getDataType() != DDTGrouped )
      {
         ...
         if ( ( ret = fd_msg_avp_setvalue( m_avp, &m_value ) ) != 0)
            throw FDException(
               EUtility::string_format("%s:%d - ERROR - Error [%d] setting AVP value for [%s]",
               __FILE__, __LINE__, ret, m_de->getName() )
            );
      }
   }
...
FDAvp &FDAvp::setAvp( struct avp *a )
{
   if ( m_avp )
      throw FDException(
         EUtility::string_format("%s:%d - ERROR - m_avp already assigned",
         __FILE__, __LINE__ )
      );
   ...
   if ( ret != 0 )
      throw FDException(
         EUtility::string_format("%s:%d - ERROR - error retrieving AVP header fd_msg_avp_hdr ret=%d",
         __FILE__, __LINE__, ret )
      );
     ...
     m_msgdel( msgdel )
{
   ...
   if ( m_msg )
   {
      ...
      if ( ret != 0 )
         throw FDException(
            EUtility::string_format("%s:%d - ERROR - Error retrieving message header fd_msg_hdr ret=%d",
            __FILE__, __LINE__, ret )
         );
      ...
      if ( FDISREQUEST(hdr) )
      {
         ...
         if ( ret != 0 )
            throw FDException(
               EUtility::string_format("%s:%d - ERROR - Error creating answer message from request fd_msg_new_answer_from_rea ret=%d",
               __FILE__, __LINE__, ret )
            );
      ...
      {
         throw FDException(
            EUtility::string_format("%s:%d - ERROR - Expected msg is not a request",
            __FILE__, __LINE__ )
         );
      }
   }
   ...
   {
      throw FDException(
         EUtility::string_format("%s:%d - ERROR - Error creating command",
         __FILE__, __LINE__ )
      );
   }
}
...
FDAvp FDMessage::findAVP( FDDictionaryEntryAVP &de )
{
   ...
   if ( ret != 0 )
      throw FDException(
         EUtility::string_format("%s:%d - ERROR - AVP not found for [%s] (vendor id %u)",
...
FDAvp FDMessage::getFirstAVP( bool &found )
{
   ...
   if ( found )
   {
      ...
      if ( ret != 0 )
         throw FDException(
            EUtility::string_format("%s:%d - INFO - unalbe to regrieve avp model",
            __FILE__, __LINE__, ret )
         );
...
FDMessage &FDMessage::sendRequest( Void (*anscb)(Void*,struct msg**), FDMessageRequest &req )
{
   ...
   if ( ret != 0 )
      throw FDException(
         EUtility::string_format("%s:%d - INFO - error attempting to send request message ret=%d",
         __FILE__, __LINE__, ret )
      );
...
FDMessage &FDMessage::sendAnswer()
{
   ...
   if ( ret != 0 )
      throw FDException(
         EUtility::string_format("%s:%d - INFO - error attempting to send answer message ret=%d",
         __FILE__, __LINE__, ret )
      );
...
Void FDMessage::addOrigin()
{
   ...
   if ( ret != 0 )
      throw FDException(
         EUtility::string_format("%s:%d - Exception - error adding Origin-Host and Origin-Realm ret=%d",
         __FILE__, __LINE__, ret )
      );
}
   ...
   : FDMessage( cde )
{
   if ( cde->isAnswer() )
      throw FDException(
         EUtility::string_format("%s:%d - INFO - attempt to create request with answer dictionary entry",
         __FILE__, __LINE__ )
      );
}
...
FDApplication &FDApplication::registerHandler( FDCommandRequest &cmd )
{
         ...
         ++it )
   {
      if ( (*it)->getDictionaryEntry().getCommandCode() == cmd.getDictionaryEntry().getCommandCode() )
         throw FDException(
            EUtility::string_format("%s:%d - ERROR - a matching command object is already registered",
            __FILE__, __LINE__ )
         );
   }
   ...
   if ( ret != 0 )
      throw FDException(
         EUtility::string_format("%s:%d - ERROR - fd_disp_register failed ret=%d",
         __FILE__, __LINE__, ret )
      );
   ...
   : m_session( NULL )
{
   ...
   if ( ret != 0 )
      throw FDException(
         EUtility::string_format("%s:%d - EXCEPTION - Error creating session ret=%d",
         __FILE__, __LINE__, ret )
      );
   ...
   if ( ret != 0 )
      throw FDException(
         EUtility::string_format("%s:%d - EXCEPTION - Error retrieving sid for session ret=%d",
         __FILE__, __LINE__, ret )
      );
...
Void FDSession::addSessionId( FDMessage &msg, FDDictionaryEntryAVP &deSessionId )
{
   ...
   if ( ret != 0 )
      throw FDException(
         EUtility::string_format("%s:%d - EXCEPTION - fd_msg_sess_set failed ret=%d",
         __FILE__, __LINE__, ret )
      );
}
...
FDPeerState FDPeer::getState()
{
   ...
   if ( !m_peer )
   {
      ...
      if ( ret != 0 )
         throw FDException(
            EUtility::string_format("%s:%d - Error retrieving peer [%s] ret=%d",
...
Void FDPeer::add()
{
   if ( m_diamid.empty() )
      throw FDException(
         EUtility::string_format("%s:%d - Diameter ID not set",
         __FILE__, __LINE__ )
      );
   ...
   if ( !m_destip.empty() )
   {
      ...
      if ( ret )
      {
         freeaddrinfo( ai );
         throw FDException(
            EUtility::string_format("%s:%d - Error [%d] retrieving address info - %s",
      ...
      if ( ret != 0 )
      {
         freeaddrinfo( ai );
         throw FDException(
            EUtility::string_format("%s:%d - Error adding endpoint [%s] ret=%d",
   ...
   if ( ret != 0 )
   {
      if ( ret != EEXIST )
         throw FDException(
            EUtility::string_format("%s:%d - Error adding diameter peer [%s] ret=%d",
            __FILE__, __LINE__, m_diamid.c_str(), ret )
         );
...
Void FDExtractor::resolve()
{
   ...
   if ( !m_reference )
   {
      if ( m_parent )
      {
         if ( !getDictionaryEntry() )
            throw FDException(
               EUtility::string_format("%s:%d - ERROR - FDExtractor dictionary entry not defined for grouped AVP",
               __FILE__, __LINE__ )
            );
      ...
      {
         throw FDException(
            EUtility::string_format("%s:%d - ERROR - FDExtractor reference and parent are not set",
            __FILE__, __LINE__ )
         );
      }
   }
   ...
   if ( m_reference && needToResolve )
   {
      ...
      if ( ret != 0 )
         throw FDException(
            EUtility::string_format("%s:%d - ERROR - FDExtractor browse returned %d direction MSG_BRW_FIRST_CHILD",
            __FILE__, __LINE__, ret )
         );
      ...
      while ( loopavp )
      {
         ...
         if ( ret != 0 )
            throw FDException(
               EUtility::string_format("%s:%d - ERROR - FDExtractor fd_msg_avp_hdr returned %d",
               __FILE__, __LINE__, ret )
            );
         ...
         if ( ret != 0 )
            throw FDException(
               EUtility::string_format("%s:%d - ERROR - FDExtractor browse returned %d direction MSG_BRW_NEXT",
               __FILE__, __LINE__, ret )
            );
      }
   }
