...
public:
   ...
   FTTime add(Int days, Int hrs, Int mins, Int secs, Int usecs)
   {
      timeval t;
      t.tv_sec =
          (days * 86400) +
   ...
   FTTime subtract(Int days, Int hrs, Int mins, Int secs, Int usecs)
   {
      timeval t;
      t.tv_sec =
          (days * 86400) +
   ...
   FTTime &operator=(const timeval &a)
   {
      set(a);
      return *this;
   }

   FTTime &operator=(LongLong ms)
   {
      set(ms);
      return *this;
   }
   ...
   static FTTime Now();
   void Format(FTString &dest, cpStr fmt, Bool local);
