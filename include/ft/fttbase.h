...
class FTThreadError_UnableToResume : public FTError
{
public:
   FTThreadError_UnableToResume();
};
class FTThreadError_UnableToSuspend : public FTError
{
public:
   FTThreadError_UnableToSuspend();
};
class FTThreadError_UnableToInitialize : public FTError
{
public:
   FTThreadError_UnableToInitialize();
};
